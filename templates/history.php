...
foreach (array_reverse($bills) as $bill) {
	...
	if ($status == '1') {
		printPaid($date, $monthbill, $due_date, $invoice);
 	}
	else {
		printUnpaid($date, $monthbill, $due_date, $fullmonth, $invoice);
	}
}

function printPaid($date, $monthbill, $due_date, $invoice){
	...
	<span class='nametext'><div style='color:#9E9E9E;'><strong>Paid</strong><div></span></a></div>
	</td><td class='month'>$date</td><td style='padding-left:2px;'>$monthbill</td>
	<td class='duedate'>$due_date</td><td class='invoice'><a class='invoice-link'>$invoice</a></td><td><div><i class='icon-ok'></i></div></td></tr>";
}
	
function printUnpaid($date, $monthbill, $due_date, $fullmonth, $invoice){
	echo "<tr class='unpaid'><td style='height:34px; padding-left:6px;' ><div class='row'><div class='col-xs-1 text-right '></div>
	<div class='col-xs-8 filelink-wrap' style='padding-left:4px;'>
	<span class='nametext'><div style='color:#CDDC39;'><strong>Pending</strong></div></span></a></div>
